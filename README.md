...
Architecture • Results • Setup • Usage
...
Equal dense/sparse weighting was selected on the development split. See results/benchmarks.md for the recorded experiments.
...
Download NFCorpus from BEIR and extract it to:
